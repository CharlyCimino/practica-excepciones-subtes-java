...
public class Vista {
     ...
     */
	public String mostrarMenuSeleccionLinea() {
		...
		System.out.print("Introducí la letra correspondiente ('S' para salir): ");
		return String.valueOf(Consola.leerCaracter());
	}
	
	/**
     * Muestra al usuario vía consola el menú de selección de estación de subte
     * @param cantEstaciones La cantidad de estaciones de la línea seleccionada para mostrar en la consola
     * @return La opción elegida
     */
